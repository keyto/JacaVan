...
(function($) {
  ...
  $(document).ready(function() {
    ...
    function initialize() {
      var map;
      var panorama;
      var var_latitude = 42.57072175722567; // Google Map Latitude
      var var_longitude = -0.5482005087266815; // Google Map Longitude
      var pin = 'images/icons/pin.svg';

      //Map pin-window details
      var title = "Alojamiento turistico";
      var hotel_name = "La Maison de l'Arc";
      var hotel_address = "Calle San Nicolas 4, Jaca";
      var hotel_desc = "Boutique La Maison de l'Arc";
      var hotel_more_desc = "ALojamiento turistico en el casco antiguo de Jaca";
